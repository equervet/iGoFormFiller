  ...
  return dispatch => {
    ...
    if (formValues) {
      ...
      newOptions.fieldMatchSettings = {
        ...
        matchiGoAltId: formValues.fieldMatchiGoAltId,
        matchiGoMaxLength: formValues.fieldMatchiGoMaxLength,
        matchiGoRegexpPattern: formValues.fieldMatchiGoRegexpPattern,
        matchiGoRadioButtonsLogic: formValues.fieldMatchiGoRadioButtonsLogic,
      };
