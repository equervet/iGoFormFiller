...
class GeneralSettingsForm extends React.PureComponent<IOwnProps> {
  ...
  public render(): JSX.Element {
    ...
    initialValues.fieldMatchiGoAltId = this.props.options.fieldMatchSettings.matchiGoAltId;
    initialValues.fieldMatchiGoMaxLength = this.props.options.fieldMatchSettings.matchiGoMaxLength;
    initialValues.fieldMatchiGoRegexpPattern = this.props.options.fieldMatchSettings.matchiGoRegexpPattern;
    initialValues.fieldMatchiGoRadioButtonsLogic = this.props.options.fieldMatchSettings.matchiGoRadioButtonsLogic;
          ...
          <Form>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-9">
                ...
                <CheckboxField name="fieldMatchPlaceholder" label={GetMessage('generalSettings_matchFields_usePlaceholder')} />
                <CheckboxField name="fieldMatchiGoAltId" label={GetMessage('generalSettings_matchFields_useiGoAltId')} />
                <CheckboxField name="fieldMatchiGoMaxLength" label={GetMessage('generalSettings_matchFields_useiGoMaxLength')} />
                <CheckboxField name="fieldMatchiGoRegexpPattern" label={GetMessage('generalSettings_matchFields_useiGoRegexpPattern')} />
                <CheckboxField name="fieldMatchiGoRadioButtonsLogic" label={GetMessage('generalSettings_matchFields_useiGoRadioButtonsLogic')} />
