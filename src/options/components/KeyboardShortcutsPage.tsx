  ...
  public render(): JSX.Element {
    ...
    return (
      <>
        ...
        <p dangerouslySetInnerHTML={GetHtmlMarkup(GetMessage('kbdShortcuts_changeInstructions1'))} />
        <p dangerouslySetInnerHTML={GetHtmlMarkup(GetMessage('kbdShortcuts_changeInstructions2'))} />
      </>
    );
  }
}
